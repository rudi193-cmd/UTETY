...
UTETY is the *reference* this core was generalized from (the anchor is UTETY's own
audit-B4 guard, backported); UTETY now consumes it via a SQLite ``Backend``
(utety/core/consent_backend.py) instead of a private copy.
"""
